...
class BCS_Admin {
    ...
    private static function organizer_form(?object $edit): void {
        ...
        echo '<p class="description bcs-span-2">Numer faktury: <code>FV/[prefiks organizatora]/[rok]/[kolejny numer]</code>. Prefiks może zawierać litery, cyfry, myślnik i podkreślenie.</p>';
