...
$constantVersionValue = $constantVersion[1] ?? '';
$check($currentVersion === $constantVersionValue && version_compare($currentVersion, '0.81', '>='), 'Wtyczka powinna mieć zsynchronizowaną wersję 0.81 lub nowszą.');
