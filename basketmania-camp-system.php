...
require_once BCS_DIR . 'includes/class-bcs-release-050.php';
require_once BCS_DIR . 'includes/class-bcs-release-050-view.php';
...
add_action('plugins_loaded', function () {
    ...
    BCS_Release_050::init();
    BCS_Release_050_View::init();
    BCS_Templates::init();
    BCS_PDF::init();
