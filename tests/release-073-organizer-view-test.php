...
if (!str_contains($bootstrap, '* Version: 0.73') || !str_contains($bootstrap, "define('BCS_VERSION', '0.73')")) $fail('Plugin version declarations are not synchronized at 0.73.');
...
if (substr_count($release, 'name="bcs_save_organizer" value="1"') < 2) $fail('The Organizer editor must expose working Save buttons at the top and bottom.');
if (!str_contains($release, 'form="bcs-organizer-form-073"')) $fail('The top Save button is not attached to the Organizer form.');
