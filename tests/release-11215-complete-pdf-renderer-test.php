...
$check(str_contains($pdf,'bool $preserve_layout=false')&&str_contains($pdf,'$useAgreementV2 = !$preserve_layout'),'Generator powinien umieć wyłączyć renderer pojedynczej umowy dla kompletu dokumentów.');
